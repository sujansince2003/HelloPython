...
start_date = week_ago.strftime(
    "%Y-%m-%d"
)  # strftime-> date time to string format i.e 2025-12-02
end_date = today.strftime("%Y-%m-%d")

weather_api_url = url = (
    f"https://api.open-meteo.com/v1/forecast?latitude=27.717245&longitude=85.323959&start_date={start_date}&end_date={end_date}&daily=temperature_2m_max,temperature_2m_min"
)
